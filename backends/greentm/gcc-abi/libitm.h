...
/* Extra API for explicit calls by the programmer to identify threads that
 * must not be blocked indefinitely as they are relevant for the progress
 * of the application.
 */
extern int _ITM_CALL_CONVENTION _ITM_initializeUnblockableThread(void);
